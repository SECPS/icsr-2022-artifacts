...
Product "CompletedTank-9": {
	...
	isAbstract: false,
	implements: [ "CompletedTank" ],
	requires: [ "IronFrame", "FreshwaterTankS", "FiltertankS", "CharcoalBone", "WaterflowSensor" ],
...
Product "CompletedTank-10": {
	...
	isAbstract: false,
	implements: [ "CompletedTank" ],
	requires: [ "IronFrame", "FreshwaterTankS", "FiltertankS", "CharcoalActive", "WaterflowSensor"  ],
...
Product "CompletedTank-11": {
	...
	isAbstract: false,
	implements: [ "CompletedTank" ],
	requires: [ "Rack1", "FreshwaterTankS", "FiltertankS", "CharcoalBone", "Nanofilter", "WaterflowSensor" ],
...
Product "CompletedTank-12": {
	...
	isAbstract: false,
	implements: [ "CompletedTank" ],
	requires: [ "Rack1", "FreshwaterTankS", "FiltertankS", "CharcoalActive", "Nanofilter", "WaterflowSensor" ],
