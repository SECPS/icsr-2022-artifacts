...
Product "Asia": {
	...
	excludes: [ "Africa", "Australia", "Brazil", "Europe", "US" ],
	component: "true"
}
...
Product "Africa": {
	...
	isAbstract: false,
	implements: [ "Electricity" ],
	excludes: [ "Asia", "Australia", "Brazil", "Europe", "US" ],
	component: "true"
}
...
Product "Australia": {
	...
	isAbstract: false,
	implements: [ "Electricity" ],
	excludes: [ "Asia", "Africa", "Brazil", "Europe", "US" ],
	component: "true"
}
...
Product "Brazil": {
	...
	isAbstract: false,
	implements: [ "Electricity" ],
	excludes: [ "Asia", "Africa", "Australia", "Europe", "US" ],
	component: "true"
}
...
Product "Europe": {
	...
	isAbstract: false,
	implements: [ "Electricity" ],
	excludes: [ "Asia", "Africa", "Australia", "Brazil", "US" ],
	component: "true"
}
...
Product "US": {
	...
	isAbstract: false,
	implements: [ "Electricity" ],
	excludes: [ "Asia", "Africa", "Australia", "Brazil", "Europe" ],
	component: "true"
}
...
Product "PumpXXL": {
	...
	isAbstract: false,
	implements: [ "Pump" ],
	excludes: [ "PumpXL", "PumpM", "PumpS", "PumpXS" ],
	component: "true"
}
...
Product "PumpXL": {
	...
	isAbstract: false,
	implements: [ "Pump" ],
	excludes: [ "PumpXXL", "PumpM", "PumpS", "PumpXS" ],
	component: "true"
}
...
Product "PumpM": {
	...
	isAbstract: false,
	implements: [ "Pump" ],
	excludes: [ "PumpXXL", "PumpXL", "PumpS", "PumpXS" ],
	component: "true"
}
...
Product "PumpS": {
	...
	isAbstract: false,
	implements: [ "Pump" ],
	excludes: [ "PumpXXL", "PumpXL", "PumpM", "PumpXS" ],
	component: "true"
}
...
Product "PumpXS": {
	...
	isAbstract: false,
	implements: [ "Pump" ],
	excludes: [ "PumpXXL", "PumpXL", "PumpM", "PumpS" ],
	component: "true"
}
